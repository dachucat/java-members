...
public class TopicController {
    ...
    public Result<TopicVo> add(@RequestBody AddTopicDto addTopicDto) {
        return Result.succeed(topicService.addTopic(addTopicDto));
    }

    @PostMapping("/delete")
    public Result delete(@RequestBody DeleteTopicDto deleteTopicDto) {
        topicService.deleteTopic(deleteTopicDto);
        return Result.succeed();
    }

    @PostMapping("/update")
    public Result<TopicVo> update(@RequestBody UpdateTopicDto updateTopicDto) {
        return Result.succeed(topicService.updateTopic(updateTopicDto));
    }
